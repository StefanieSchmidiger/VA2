...
%
\subsubsection{Acknowledgements vs. Negative Acknowledgements}
...
\spicv{TestSetupWithQGroundControl_2WlSidesConnected.png}{Setup for testing}{\label{fig:picTestingSetup}}{120}%
...
\spicv{FilteringMethod.png}{Delay caused by filtering the samples over 5 seconds}{\label{fig:picFilteringMethod}}{140}%
