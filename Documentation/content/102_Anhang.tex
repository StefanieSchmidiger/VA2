...
\includepdf[pages=-,angle=90]{BaseBoardSchematic.pdf}
\includepdf[pages=-,angle=90]{TeensyAdapterBoardSchematic.pdf}
%
%
%
%
\chapter{Provided Documentation} \label{app:DocumentationAndreasAlbisser}
...
\includepdf[pages=-]{AufsetzenEntwicklungsumgebung.pdf}
\includepdf[pages=-]{DocumentationAndreasAlbisser.pdf}